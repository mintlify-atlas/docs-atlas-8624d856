...
<Warning>
  **EDUCATIONAL PURPOSES ONLY** - This software is provided for security research and malware analysis only. Unauthorized access to computer systems is illegal. See the [Legal Notice](/security/legal) for full terms.
</Warning>
